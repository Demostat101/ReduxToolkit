  ...
  return (
    <section className='text-white px-[30px] py-[20px]'>
      ...
      <form action="" onSubmit={e => e.preventDefault()}>
        ...
        <button className={!canSave ? 'w-full bg-[#d3cbcb] text-black font-[500] rounded-md py-2' : 'w-full bg-white text-black font-[500] rounded-md py-2'} type='button' onClick={onSavePostClicked} disabled={!canSave}>Save Post</button>
      </form>
    </section>
  )
}
